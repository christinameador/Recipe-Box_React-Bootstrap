...
var RecipeItem = React.createClass({ displayName: "RecipeItem",
  ...
  render: function () {
    ...
    var ingredients = this.props.ingredients.map(function (item) {
      return (
        React.createElement("li", { className: "list-group-item", key: item }, item));

    });

    return (

      React.createElement("div", { className: "recipeItem" },
      React.createElement("div", { className: classname },
      React.createElement("div", { className: "panel-heading", onClick: this.handleClick },
      React.createElement("h4", { className: "panel-title" },
      this.props.title)),


      React.createElement("div", { className: "panel-wrap", ref: "wrapper" },
      ...
      React.createElement("button", { className: "btn btn-danger", onClick: this.handleDelete }, "Delete"),
      React.createElement("button", { className: "btn btn-default", onClick: this.handleEdit }, "Edit")))))));
...
var RecipeList = React.createClass({ displayName: "RecipeList",
  ...
  render: function () {
    ...
    var recipes = this.props.recipes.map(function (recipe, idx) {
      return (
        React.createElement(RecipeItem, { key: idx, index: idx, title: recipe.title, ingredients: recipe.ingredients, onEdit: self.props.onEdit, onDelete: self.props.onDelete }));
...
var RecipeModal = React.createClass({ displayName: "RecipeModal",
  ...
  render: function () {
    ...
    React.createElement(Button, { bsStyle: "primary", onClick: this.handleAdd }, "Add Recipe") :
    React.createElement(Button, { bsStyle: "primary", onClick: this.handleEdit }, "Edit Recipe");
    ...
    return (
      React.createElement(Modal, { show: this.props.show, onHide: this.props.onHide },
      React.createElement(Modal.Header, { closeButton: true },
      React.createElement(Modal.Title, null, "Recipe")),
...
var RecipeContainer = React.createClass({ displayName: "RecipeContainer",
  ...
  render: function () {
    ...
    React.createElement(RecipeModal, { status: "add", show: this.state.showModal, onHide: this.close, addRecipe: this.addRecipe }) :
